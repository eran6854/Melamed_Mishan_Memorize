...
class FirstLetterGameHebrew(BoxLayout):
    def __init__(self, given_str: str, scroll_view, **kwargs):
        ...
        for line in self.widgets:
            ...
            spacer = Widget()  # Add this spacer widget
            line_layout.add_widget(spacer)  # Add the spacer to the layout
        ...
        bottom_spacer = Widget(size_hint_y=None, height=max(0, Window.height - self.get_total_lines_height()))
